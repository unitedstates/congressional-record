...
def bolier_senate_content():
    senate_content = cr_parser.parse_to_string("test/test_files/boiler_plate/CREC-2014-01-28-pt1-PgS493-2.txt",
                                               logdir="test/test_output", outdir="test/test_output")
...
class test_results(unittest.TestCase):
    ...
    def test_mr(self):
        content = cr_parser.parse_to_string("test/test_files/names/CREC-2013-01-23-pt1-PgE49-2.txt",
                                            logdir="test/test_output", outdir="test/test_output")
        content = str(content)
    ...
    def test_ms(self):
        content = cr_parser.parse_to_string("test/test_files/names/CREC-2013-01-23-pt1-PgE50-3.txt",
                                            logdir="test/test_output", outdir="test/test_output")
        content = str(content)
    ...
    def test_mrs(self):
        content = cr_parser.parse_to_string("test/test_files/names/CREC-2013-01-23-pt1-PgE53.txt",
                                            logdir="test/test_output", outdir="test/test_output")
        content = str(content)
    ...
    def test_with_state(self):
        content = cr_parser.parse_to_string("test/test_files/names/CREC-2013-01-23-pt1-PgE53-4.txt",
                                            logdir="test/test_output", outdir="test/test_output")
        content = str(content)
    ...
    def test_speaker(self):
        content = cr_parser.parse_to_string("test/test_files/names/CREC-2013-01-23-pt1-PgH225-5.txt",
                                            logdir="test/test_output", outdir="test/test_output")
        content = str(content)
    ...
    def test_protempore(self):
        content = cr_parser.parse_to_string("test/test_files/names/CREC-2013-01-23-pt1-PgH251-2.txt",
                                            logdir="test/test_output", outdir="test/test_output")
        content = str(content)
    ...
    def test_acting_protemp(self):
        content = cr_parser.parse_to_string("test/test_files/names/CREC-2013-01-23-pt1-PgS189-5.txt",
                                            logdir="test/test_output", outdir="test/test_output")
        content = str(content)
    ...
    def test_presiding(self):
        content = cr_parser.parse_to_string("test/test_files/names/CREC-2013-01-23-pt1-PgS226-5.txt",
                                            logdir="test/test_output", outdir="test/test_output")
        content = str(content)
    ...
    def test_excutive(self):
        content = cr_parser.parse_to_string("test/test_files/SOTU/CREC-2014-01-28-pt1-PgH1473-5.txt",
                                            logdir="test/test_output", outdir="test/test_output")
        content = str(content)
    ...
    def test_chamber(self):
        extention_content = cr_parser.parse_to_string('test/test_files/boiler_plate/CREC-2014-01-28-pt1-PgE123-4.txt',
                                                      logdir="test/test_output", outdir="test/test_output")
