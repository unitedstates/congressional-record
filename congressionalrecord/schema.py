...
class Header(BaseModel):
    ...
    chamber: str = Field(..., description="Chamber of Congress ('Senate' or 'House')")
    pages: str = Field(
...
class RelatedBill(BaseModel):
    ...
    type: str = Field(..., description="Bill type (e.g., 'SRES' for Senate Resolution)")
...
class ContentItem(BaseModel):
    ...
    itemno: int = Field(..., description="Sequential item number within this document")
